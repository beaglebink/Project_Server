...
namespace ClothesEffectTags
{
	UE_DEFINE_GAMEPLAY_TAG(Default, FName{ TEXTVIEW("Clothes.Effect.Default") })
		...
		UE_DEFINE_GAMEPLAY_TAG(LaoEddiesNightRobe, FName{ TEXTVIEW("Clothes.Effect.LaoEddiesNightRobe") })
		UE_DEFINE_GAMEPLAY_TAG(MoonDoggies, FName{ TEXTVIEW("Clothes.Effect.MoonDoggies") })
		UE_DEFINE_GAMEPLAY_TAG(Garbage, FName{ TEXTVIEW("Clothes.Effect.Garbage") })
		UE_DEFINE_GAMEPLAY_TAG(PDEnergizerBattery, FName{ TEXTVIEW("Clothes.Effect.PDEnergizerBattery") })
		UE_DEFINE_GAMEPLAY_TAG(DesperadoPoncho, FName{ TEXTVIEW("Clothes.Effect.DesperadoPoncho") })
		UE_DEFINE_GAMEPLAY_TAG(DeliverySpandex, FName{ TEXTVIEW("Clothes.Effect.DeliverySpandex") })
		...
		UE_DEFINE_GAMEPLAY_TAG(NetworkSpecialist, FName{ TEXTVIEW("Clothes.Effect.NetworkSpecialist") })
